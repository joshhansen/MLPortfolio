...
# Second approach
# Now we allow the source (document or speaker) to influence the knowledge extraction
# We also allow variable numbers of propositions to be extracted
# And we use a generic value space as well as a generic knowledge (or value) space
...
class Encoder(tf.keras.layers.Layer):
 ...
 def __init__(self, *,
  ...
  self.source_emb = tf.keras.layers.Embedding(source_count, emb)
